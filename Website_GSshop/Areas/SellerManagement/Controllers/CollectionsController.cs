...
namespace Website_GSshop.Areas.SellerManagement.Controllers
{
    public class CollectionsController : Controller
    {
        ...
        String seller_qlbst = "/SellerManagement/Collections/Index";
        // GET: SellerManagement/Collections
        public ActionResult Index()
        {
            ...
            List<Collection> col = db.Collection.Where(n => n.seller_id == se.seller_id && n.collection_bin == true).ToList();
            return View(col);
        }

        // GET: SellerManagement/Collections/Details/5
        ...
        // GET: SellerManagement/Collections/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: SellerManagement/Collections/Create
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        public ActionResult Create([Bind(Include = "collection_id,collection_name,collection_image1,collection_image2,collection_image3,collection_datecreate,collection_active,collection_bin,seller_id")] Collection collection, HttpPostedFileBase fileUpload1, HttpPostedFileBase fileUpload2, HttpPostedFileBase fileUpload3)
        {
            ...
            else
            {
                ...
                collection.seller_id = seller.seller_id;
                db.SaveChanges();
                return Redirect(seller_qlbst);
            }
        }

        // GET: SellerManagement/Collections/Edit/5
        ...
        // POST: SellerManagement/Collections/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to, for 
        // more details see https://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        public ActionResult Edit([Bind(Include = "collection_id,collection_name,collection_image1,collection_image2,collection_image3,collection_datecreate,collection_active,collection_bin,seller_id")] Collection collection, HttpPostedFileBase collection_image1a, HttpPostedFileBase collection_image2a, HttpPostedFileBase collection_image3a)
        {
        ...
        // GET: SellerManagement/Collections/Delete/5
        ...
        // POST: SellerManagement/Collections/Delete/5
